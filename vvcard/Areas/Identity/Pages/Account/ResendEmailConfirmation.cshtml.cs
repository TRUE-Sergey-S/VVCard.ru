...
namespace vvcard.Areas.Identity.Pages.Account
{
    ...
    public class ResendEmailConfirmationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (user == null)
            {
                ModelState.AddModelError(string.Empty, "Такой адрес не зарегистрирован или уже подтвержден");
                return Page();
            }
            ...
            ModelState.AddModelError(string.Empty, "Письмо с подтверждением отправлено. Проверьте свою электронную почту");
            return Page();
        }
    }
}
